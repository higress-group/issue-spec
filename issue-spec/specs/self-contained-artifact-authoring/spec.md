# self-contained-artifact-authoring

## Purpose

Guarantee that proposal, design, SPEC, and TASK artifacts are authored to be self-contained for a reader with no shared session context, capturing environment-independent background, assumptions, decisions, and rejected alternatives, with advisory (non-blocking) completeness diagnostics.
