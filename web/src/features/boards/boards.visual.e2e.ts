...
test("organization and repository navigation stays inside visible context", async ({ page }, testInfo) => {
  ...
  await expect(page).toHaveURL(`/changes/${orgId}/repos/${repoId}`);
...
const cards: ChangeCardModel[] = [
  {
    ...
    tasks: progress(12, 8, 2, 0, 2), processes: progress(8, 5, 2, 0, 1), anomalies: [], updated_at: "2026-07-11T05:00:00Z",
  },
  {
    ...
    tasks: progress(7, 3, 1, 2, 1), processes: progress(4, 1, 1, 1, 1), anomalies: ["missing_required_links", "implement_missing_predecessor"], updated_at: "2026-07-11T04:00:00Z",
  },
  {
    ...
    tasks: progress(6, 6, 0, 0, 0), processes: progress(5, 5, 0, 0, 0), anomalies: [], updated_at: "2026-07-11T03:00:00Z",
  },
  {
    ...
    tasks: progress(2, 0, 1, 0, 1), processes: progress(1, 0, 0, 0, 1), anomalies: ["unsupported_marker_version", "marker_label_mismatch"], updated_at: "2026-07-11T02:00:00Z",
  },
];
