...
export function IssueWorkspacePage() {
  ...
  return <div className="issue-page issue-workspace"><header className="issue-hero"><div><span className="issue-kicker">{t("issues.workspace.eyebrow")}</span><h1>{t("issues.workspace.title")}</h1><p>{t("issues.workspace.description")}</p></div><div className="hero-seal" aria-hidden="true"><span>IS</span><small>{t("issues.list.title")}</small></div></header>
