...
const CanonicalIssueRoutePage = lazy(() => import("./canonical-route").then((module) => ({ default: module.CanonicalIssueRoutePage })));
...
const contribution: FeatureContribution = {
  ...
  routes: [
    ...
    { path: ":owner/:repo/issues/:issueNumber", element: <LazyIssueRoute><CanonicalIssueRoutePage /></LazyIssueRoute> },
  ],
};
