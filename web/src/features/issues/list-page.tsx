...
import { IssueLoading, IssueStatus, RepositoryGate } from "./repository-context";
...
function IssueList({ active }: { active: ActiveRepository }) {
  ...
  return <div className="issue-page"><header className="repo-masthead"><div><Link className="issue-back" to="/issues">Issue desk</Link><span>/</span><strong>{owner} / {repo}</strong><h1>Issues</h1></div><Link className="issue-button primary" to={`/issues/${active.organization.id}/${active.repository.repository.id}/new`}>New issue</Link></header>
