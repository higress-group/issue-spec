...
cp "tests/e2e/requirements-onboarding.spec.ts-snapshots/requirements-release-desktop-1440-$platform.png" "$assets/requirements-release.png"
...
cp "tests/e2e/requirements-onboarding.spec.ts-snapshots/requirements-release-zh-CN-desktop-1440-$platform.png" "$assets/requirements-release.zh-CN.png"
