...
func TestRepositoryAuthorizationMatrix(t *testing.T) {
	...
	tests := []struct {
		...
		{"repo scope cannot replace evidence scope", active(serverauth.CredentialPAT, "repo"), RepositoryRequest{Scope: scope, Operation: OperationPublishEvidence, DesignatedEvidenceWriter: true}, owner, false, true, ReasonCredentialScope, PermissionNone, false},
		{"admin repo cannot replace evidence scope", active(serverauth.CredentialPAT, "admin:repo"), RepositoryRequest{Scope: scope, Operation: OperationPublishEvidence, DesignatedEvidenceWriter: true}, owner, false, true, ReasonCredentialScope, PermissionNone, false},
		{"session admin cannot replace evidence scope", active(serverauth.CredentialSession), RepositoryRequest{Scope: scope, Operation: OperationPublishEvidence, DesignatedEvidenceWriter: true}, owner, false, true, ReasonCredentialScope, PermissionNone, false},
		{"recovery admin cannot replace evidence scope", active(serverauth.CredentialRecovery, "site:admin"), RepositoryRequest{Scope: scope, Operation: OperationPublishEvidence, DesignatedEvidenceWriter: true}, owner, false, true, ReasonCredentialScope, PermissionNone, false},
		{"evidence writer designation required", active(serverauth.CredentialPAT, "evidence:write"), RepositoryRequest{Scope: scope, Operation: OperationPublishEvidence}, owner, false, true, ReasonEvidenceWriterRequired, PermissionWrite, false},
		{"evidence scope and designation allow", patFor([]string{"evidence:write"}, repoID), RepositoryRequest{Scope: scope, Operation: OperationPublishEvidence, DesignatedEvidenceWriter: true}, owner, true, true, ReasonAllowed, PermissionWrite, false},
		{"evidence still needs identity authority", patFor([]string{"evidence:write"}, repoID), RepositoryRequest{Scope: scope, Operation: OperationPublishEvidence, DesignatedEvidenceWriter: true}, authorityFacts{Exists: true, IdentityActive: true, Visibility: models.VisibilityPublic}, false, true, ReasonInsufficientPermission, PermissionRead, false},
		{"evidence still needs repository cap", patFor([]string{"evidence:write"}, otherRepoID), RepositoryRequest{Scope: scope, Operation: OperationPublishEvidence, DesignatedEvidenceWriter: true}, owner, false, false, ReasonRepositoryCap, PermissionNone, false},
