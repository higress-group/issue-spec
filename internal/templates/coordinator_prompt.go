...
func CoordinatorPrompt(bundle runnercontext.Bundle, opts CoordinatorPromptOptions) (string, error) {
	...
	b.WriteString("- Write optional planning state through issue-spec CLI commands, not a runner writeback envelope. Select a bounded simple Issue or Proposal with optional Design/Implement/TASK/PROCESS by engineering risk, never file count.\n")
