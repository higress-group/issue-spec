...
func CoordinatorPrompt(bundle runnercontext.Bundle, opts CoordinatorPromptOptions) (string, error) {
	...
	b.WriteString("8. Provider-native review and current configured checks own merge authority. The Coordinator never fabricates reviewer identity, copies decisions into REVIEW/VERIFY comments, or turns PROCESS completion, rationale, receipts, coverage, or finalization into readiness. Route blockers to their real owner and rerun read-only merge-check.\n")
