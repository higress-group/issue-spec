...
- `--max-concurrency <n>` can run independent sessions in parallel. The default is 8. Commands for the same public session are serialized by a workspace/session lock.
